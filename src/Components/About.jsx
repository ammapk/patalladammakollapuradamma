            ...
            <section id="timeline">
                ...
                <div className="tl-item">
                    ...
                    <div className="tl-content">
                        <h1>ಶ್ರೀ ಪಟ್ಟಲ್ಲದಮ್ಮ ಶ್ರೀ ಕೊಲ್ಲಾಪುರದಮ್ಮ</h1>
                        <p>
...
ಅದು ಸ್ವಯಂಬು ದೇವಾಲಯ. ಇದಕ್ಕೆ ಸುಮಾರು 25 ವರ್ಷಗಳ ಇತಿಹಾಸವಿದೆ.
                ...
                <div className="tl-item">
                    ...
                    <div className="tl-content">
                        <h1 className="f3 text--accent ttu">ಶ್ರೀ ಮಾರಮ್ಮದೇವಿ ಮತ್ತು ಶ್ರೀ ಪಟ್ಟಲ್ಲದಮ್ಮ ಶ್ರೀ ಕೊಲ್ಲಾಪುರದಮ್ಮ</h1>
                        <p>
                ...
                <div className="tl-item">
                    ...
                    <div className="tl-content">
                        <h1 className="f3 text--accent ttu">ಭಗವಾನ್ ಶ್ರೀ ಸ್ಕಂದ ಮತ್ತು ಭಗವಾನ್ ಶ್ರೀ ಶಿವ</h1>
                        <p>ಸುಬ್ರಹ್ಮಣ್ಯ ಮತ್ತು ಶಿವನ ಆಶೀರ್ವಾದವನ್ನೂ ಪಡೆಯಿರಿ. ಈ ಸುಬ್ರಹ್ಮಣ್ಯ ದೇವಸ್ಥಾನವು ಕುಕ್ಕೆ ಸುಬ್ರಹ್ಮಣ್ಯ ದೇವಸ್ಥಾನದಷ್ಟು ಶಕ್ತಿಶಾಲಿಯಾಗಿದೆ. ಭಕ್ತರು ಆಶೀರ್ವಾದ ಪಡೆದಿದ್ದಾರೆ ಮತ್ತು ಅವರ ಸಮಸ್ಯೆಗಳಿಂದ ಮುಕ್ತಿ ಪಡೆದಿದ್ದಾರೆ.</p>
                    </div>
                ...
                <div className="tl-item">
                    ...
                    <div className="tl-content">
                        <h1 className="f3 text--accent ttu">ಭಗವಾನ್ ಶ್ರೀ ಬಸವಣ್ಣ</h1>
                        <p>ಚಿಕರಸಿನಕೆರೆ ಕಾಲಭೈರವೇಶ್ವರ ದೇವಸ್ಥಾನದಲ್ಲಿ ಬಸಪ್ಪನ ಕುರಿತು ಹಲವು ಪವಾಡಗಳಿವೆ. ಈ ದೇವಾಲಯದ ಸ್ವಾಮಿ ಬಸವಣ್ಣ ಕೂಡ ಕಾಲಭೈರವೇಶ್ವರ ದೇವಾಲಯದ ಬಸಪ್ಪನಂತೆ ದೈವಿಕರಾಗಿದ್ದಾರೆ. ಇದು ಅನೇಕ ಭಕ್ತರನ್ನು ಆಶೀರ್ವದಿಸಿದೆ ಮತ್ತು ಅವರ ಪಾಪಗಳಿಂದ ಅವರನ್ನು ಗುಣಪಡಿಸಿದೆ.</p>
                    </div>
